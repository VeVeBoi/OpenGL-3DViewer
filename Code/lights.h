...
public:
	...
	void sendToShader(Shader& program)
	{
		...
		program.setVec1f(this->intensity, "pointLight.intensity");
		program.setVec3f(this->color, "pointLight.color");
		program.setVec1f(this->constant, "pointLight.constant");
		program.setVec1f(this->linear, "pointLight.linear");
		program.setVec1f(this->quadratic, "pointLight.quadratic");
	}
};